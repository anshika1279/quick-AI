...
const RemoveBackground = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start gap-4
    text-slate-700'>
        {/* left col*/ }
        ...
        border-gray-200'>
          ...
          <p className='text-xs test-gray-500 font-light mt-1'>Supports JPG, PNG, and other image formats.</p>
